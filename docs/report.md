...
|Название сценария|Описание|
|---|---------|
|НС-1|Тест Негативного сценария 1. Двигатель был скомпроментирован, но так как ввёден модуль engine_controller контролирующий блокировку/разблокировку двигателя на физическом уровне, то попытки запустить двигатель окажутся неуспешными, ЦБ не нарушаются|
