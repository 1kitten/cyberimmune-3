...
|12. access_validator|Валидирует токен доступа, запрашивает/получает токены от системы управления парком автомобилей и мобильного приложения клиента и сравнивает для разрешения вопроса доступа|Отправляет 0 или 1 в IC взависимости от наличия доступа|
...
|14. date_validator|Получает телеметрию от eblocks и получает телеметрию от мобильного приложения, сравнивает правдоподобность данных о геолакации, скорости,  также правдобность телеметрии автомобиля|Отправляет 0 или 1 в IC взависимости от правдоподобности телеметрии|
...
|17. vehicle_breaking|Тормозная система|Отправляет данные в eblocks|
