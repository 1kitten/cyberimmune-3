...
|:--|:--|
|IoT Система|Занимается взаимодействием с внутренними и внешними сервисами. На основе полученной информации принимает решения по поводу физического доступа к автомобилю|
|Модуль технической готовности|Сообщает электронным блокам информацию о текущем состоянии физических устройств автомобиля|
|Модуль управления двигателем|Оперирует состоянием двигателя автомобиля|
|Модуль навигации|Получает текущие координаты автомобиля по GPS и отправляет эту информацию в электронные блоки|
|Модуль управления дверьми|Занимается открытием и закрытие дверей автомобиля|
|Электронные блоки системы|Занимается сбором телеметрии автомобиля|
